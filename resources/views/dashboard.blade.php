        ...
        <div class="card border-0 shadow" style="background-color: #fac0b9">
            <div class="card-header d-sm-flex flex-row align-items-center flex-0">
                <div class="d-block mb-3 mb-sm-0">
                    <div class="fs-5 fw-normal mb-2">{{ __('ui.sales_value') }}</div>
                    <h2 class="fs-3 fw-extrabold">$10,567</h2>
                    <div class="small mt-2"> 
                        <span class="fw-normal me-2">{{ __('ui.yesterday') }}</span>                              
                        <span class="fas fa-angle-up text-success"></span>                                   
                        <span class="text-success fw-bold">10.57%</span>
                    </div>
                </div>
                <div class="d-flex ms-auto">
                    <a href="#" class="btn btn-secondary btn-sm me-2">{{ __('ui.month') }}</a>
                    <a href="#" class="btn btn-sm me-3">{{ __('ui.week') }}</a>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row d-block d-xl-flex align-items-center">
                    <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                        ...
                        <div class="d-sm-none">
                            <h2 class="h5">{{ __('ui.customers') }}</h2>
                            <h3 class="fw-extrabold mb-1">345,678</h3>
                        </div>
                    </div>
                    <div class="col-12 col-xl-7 px-xl-0">
                        <div class="d-none d-sm-block">
                            <h2 class="h6 text-gray-400 mb-0">{{ __('ui.customers') }}</h2>
                        ...
                        <div class="small d-flex mt-1">                               
                            <div>{{ __('ui.since_last_month') }} <svg class="icon icon-xs text-success" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M14.707 12.707a1 1 0 01-1.414 0L10 9.414l-3.293 3.293a1 1 0 01-1.414-1.414l4-4a1 1 0 011.414 0l4 4a1 1 0 010 1.414z" clip-rule="evenodd"></path></svg><span class="text-success fw-bolder">22%</span></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row d-block d-xl-flex align-items-center">
                    <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                        ...
                        <div class="d-sm-none">
                            <h2 class="fw-extrabold h5">{{ __('ui.revenue') }}</h2>
                            <h3 class="mb-1">$43,594</h3>
                        </div>
                    </div>
                    <div class="col-12 col-xl-7 px-xl-0">
                        <div class="d-none d-sm-block">
                            <h2 class="h6 text-gray-400 mb-0">{{ __('ui.revenue') }}</h2>
                        ...
                        <div class="small d-flex mt-1">                               
                            <div>{{ __('ui.since_last_month') }} <svg class="icon icon-xs text-danger" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg><span class="text-danger fw-bolder">2%</span></div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body">
                <div class="row d-block d-xl-flex align-items-center">
                    <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                        ...
                        <div class="d-sm-none">
                            <h2 class="fw-extrabold h5"> {{ __('ui.bounce_rate') }}</h2>
                            <h3 class="mb-1">50.88%</h3>
                        </div>
                    </div>
                    <div class="col-12 col-xl-7 px-xl-0">
                        <div class="d-none d-sm-block">
                            <h2 class="h6 text-gray-400 mb-0"> {{ __('ui.bounce_rate') }}</h2>
...
<div class="row">
    <div class="col-12 col-xl-8">
        <div class="row">
                ...
                <div class="card border-0 shadow">
                    <div class="card-header">
                        <div class="row align-items-center">
                            <div class="col">
                                <h2 class="fs-5 fw-bold mb-0">{{ __('ui.page_visits') }}</h2>
                            </div>
                            <div class="col text-end">
                                <a href="#" class="btn btn-sm btn-primary">{{ __('ui.see_all') }}</a>
                            </div>
                        </div>
                    </div>
                    <div class="table-responsive">
                        <table class="table align-items-center table-flush">
                            ...
                            <tr>
                                <th class="border-bottom" scope="col">{{ __('ui.page_name') }}</th>
                                <th class="border-bottom" scope="col">{{ __('ui.page_views') }}</th>
                                <th class="border-bottom" scope="col">{{ __('ui.page_value') }}</th>
                                <th class="border-bottom" scope="col">{{ __('ui.bounce_rate') }}</th>
                            </tr>
                            </thead>
                            <tbody>
                            <tr>
            ...
            <div class="col-12 col-xxl-6 mb-4">
                <div class="card border-0 shadow">
                    <div class="card-header border-bottom d-flex align-items-center justify-content-between">
                       <h2 class="fs-5 fw-bold mb-0">{{ __('ui.team_members') }}</h2>
                        <a href="#" class="btn btn-sm btn-primary">{{ __('ui.see_all') }}</a>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-12 col-xxl-6 mb-4">
                <div class="card border-0 shadow">
                    <div class="card-header border-bottom d-flex align-items-center justify-content-between">
                        <h2 class="fs-5 fw-bold mb-0">{{ __('ui.progress_track') }}</h2>
                         <a href="#" class="btn btn-sm btn-primary">{{ __('ui.see_tasks') }}</a>
                     </div>
                    <div class="card-body">
                        <!-- Project 1 -->
                        <div class="row mb-4">
    ...
    <div class="col-12 col-xl-4">
        ...
        <div class="col-12 px-0">
            <div class="card border-0 shadow">
                <div class="card-body">
                    <h2 class="fs-5 fw-bold mb-1">{{ __('ui.acquisition') }}</h2>
                    ...
                    <div class="d-block">
                        <div class="d-flex align-items-center me-5">
                            ...
                            <div class="d-block">
                                <label class="mb-0">{{ __('ui.bounce_rate') }}</label>
