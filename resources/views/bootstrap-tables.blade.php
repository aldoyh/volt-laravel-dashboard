...
<div class="py-4">
    <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
        <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
            ...
            <li class="breadcrumb-item"><a href="#">{{ __('ui.breadcrumb_tables') }}</a></li>
            <li class="breadcrumb-item active" aria-current="page">{{ __('ui.bootstrap_tables') }}</li>
        </ol>
    </nav>
    <div class="d-flex justify-content-between w-100 flex-wrap">
        <div class="mb-3 mb-lg-0">
            <h1 class="h4">{{ __('ui.bootstrap_tables') }}</h1>
            <p class="mb-0">{{ __('ui.bootstrap_tables_desc') }}</p>
        </div>
        <div>
            ...
            <table class="table table-centered table-nowrap mb-0 rounded">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th class="border-0">{{ __('ui.traffic_source') }}</th>
                        <th class="border-0">{{ __('ui.source_type') }}</th>
                        <th class="border-0">{{ __('ui.category') }}</th>
                        <th class="border-0">{{ __('ui.global_rank_col') }}</th>
                        <th class="border-0">{{ __('ui.traffic_share') }}</th>
                        <th class="border-0 rounded-end">{{ __('ui.change') }}</th>
                    </tr>
                </thead>
                <tbody>
                    <!-- Item -->
