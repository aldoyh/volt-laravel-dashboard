...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item"><a href="#">{{ __('ui.breadcrumb_volt') }}</a></li>
                <li class="breadcrumb-item active" aria-current="page">{{ __('ui.transactions') }}</li>
            </ol>
        </nav>
        <h2 class="h4">{{ __('ui.all_orders') }}</h2>
        <p class="mb-0">{{ __('ui.analytics_desc') }}</p>
    </div>
    <div class="btn-toolbar mb-2 mb-md-0">
        ...
        <div class="btn-group ms-2 ms-lg-3">
            <button type="button" class="btn btn-sm btn-outline-gray-600">{{ __('ui.share') }}</button>
            <button type="button" class="btn btn-sm btn-outline-gray-600">{{ __('ui.export') }}</button>
        </div>
    </div>
</div>
    ...
    <div class="row align-items-center justify-content-between">
        <div class="col col-md-6 col-lg-3 col-xl-4">
            <div class="input-group me-2 me-lg-3 fmxw-400">
                ...
                <input type="text" class="form-control" placeholder="{{ __('ui.search_orders') }}">
            </div>
        </div>
        <div class="col-4 col-md-2 col-xl-1 ps-md-0 text-end">
            <div class="dropdown">
                <button class="btn btn-link text-dark dropdown-toggle dropdown-toggle-split m-0 p-1" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    ...
                    <span class="visually-hidden">{{ __('ui.toggle_dropdown') }}</span>
                </button>
                <div class="dropdown-menu dropdown-menu-xs dropdown-menu-end pb-0">
                    <span class="small ps-3 fw-bold text-dark">{{ __('ui.show') }}</span>
    ...
    <table class="table table-hover">
        <thead>
            <tr>
                ...
                <th class="border-gray-200">{{ __('ui.bill_for') }}</th>						
                <th class="border-gray-200">{{ __('ui.issue_date') }}</th>
                <th class="border-gray-200">{{ __('ui.due_date') }}</th>
                <th class="border-gray-200">{{ __('ui.total') }}</th>
                <th class="border-gray-200">{{ __('ui.status') }}</th>
                <th class="border-gray-200">{{ __('ui.action') }}</th>
            </tr>
        </thead>
        <tbody>
            <!-- Item -->
                ...
                <td>
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu py-0">
                            <a class="dropdown-item rounded-top" href="#"><span class="fas fa-eye me-2"></span>{{ __('ui.view_details') }}</a>
                            <a class="dropdown-item" href="#"><span class="fas fa-edit me-2"></span>{{ __('ui.edit') }}</a>
                            <a class="dropdown-item text-danger rounded-bottom" href="#"><span class="fas fa-trash-alt me-2"></span>{{ __('ui.remove') }}</a>
                        </div>
                    </div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td><span class="fw-normal">1 May 2020</span></td>
                <td><span class="fw-bold">$799,00</span></td>
                <td><span class="fw-bold text-success">{{ __('ui.status_paid') }}</span></td>
                <td>
                    <div class="btn-group">
                        <button class="btn btn-link text-dark dropdown-toggle dropdown-toggle-split m-0 p-0" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="icon icon-sm">
            ...
            <tr>
                ...
                <td><span class="fw-bold text-danger">{{ __('ui.status_cancelled') }}</span></td>
                <td>
                    <div class="btn-group">
                        <button class="btn btn-link text-dark dropdown-toggle dropdown-toggle-split m-0 p-0" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="icon icon-sm">
