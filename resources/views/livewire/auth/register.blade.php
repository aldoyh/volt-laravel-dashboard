                    ...
                    <div class="col-12 d-flex align-items-center justify-content-center">
                        <div class="bg-white shadow border-0 rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                            <div class="text-center text-md-center mb-4 mt-md-0">
                                <h1 class="mb-0 h3">{{ __('ui.create_account') }}</h1>
                            </div>
                            <form wire:submit.prevent="register" action="#" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <!-- Form -->
                                    <div class="form-group mb-4">
                                        <label for="confirm_password">{{ __('ui.confirm_password') }}</label>
                                        <div class="input-group">
                                            ...
                                            <input wire:model.blur="passwordConfirmation" type="password" placeholder="Confirm Password" class="form-control" id="confirm_password" required>
                                        </div>  
                                    </div>
                                    <!-- End of Form -->
                            ...
                            <div class="mt-3 mb-4 text-center">
                                <span class="fw-normal">{{ __('ui.or') }}</span>
                            </div>
                            ...
                            <div class="d-flex justify-content-center align-items-center mt-4">
                                <span class="fw-normal">
                                    ...
                                    <a href="{{ route('login') }}" class="fw-bold">{{ __('ui.login_here') }}</a>
                                </span>
                            </div>
                        </div>
                    </div>
