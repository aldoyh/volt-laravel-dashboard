    ...
    <section class="vh-lg-100 mt-5 mt-lg-0 bg-soft d-flex align-items-center">
        <div class="container">
            <div class="row justify-content-center form-bg-image">
                <p class="text-center"><a href="{{ route('login') }}" class="text-gray-700"><i class="fas fa-angle-left me-2"></i> {{ __('ui.back_to_login') }}</a></p>
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="bg-white shadow border-0 rounded p-4 p-lg-5 w-100 fmxw-500">
                        <h1 class="h3 mb-4">{{ __('ui.reset_password_title') }}</h1>
                        <form wire:submit.prevent="resetPassword" action="#" method="POST">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input wire:model.blur="password" type="password" placeholder="Password" class="form-control" id="password" required>
                                </div>  
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input wire:model.blur="passwordConfirmation" type="password" placeholder="Confirm Password" class="form-control" id="password_confirmation" required>
                                </div>  
                            </div>
                            <!-- End of Form -->
                            @if($isPasswordChanged)
                                <div class="alert alert-success" role="alert">
                                    {{ __('ui.password_changed') }}
                                </div>
                            @endif
                            @if($wrongEmail)
                            ...
                            @endif
                            <div class="d-grid">
                                <button type="submit" class="btn btn-gray-800">{{ __('ui.reset_password_btn') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
