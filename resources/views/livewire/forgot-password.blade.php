                        ...
                        <form wire:submit.prevent="recoverPassword" action="#" method="POST">
                            ...
                            @if($showDemoNotification)
                                <div class="alert alert-danger" role="alert">
                                    {{ __('ui.demo_restriction') }}
                                </div>
                            @endif
                            <div class="d-grid">
                                <button type="submit" class="btn btn-gray-800">{{ __('ui.recover_password') }}</button>
                            </div>
                        </form>
                    </div>
                </div>
