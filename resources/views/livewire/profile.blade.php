    ...
    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
        <div>
            <button class="btn btn-secondary me-2 dropdown-toggle" data-bs-toggle="dropdown"
                ...
                <span class="fas fa-plus me-2"></span>{{ __('ui.new') }}
            </button>
    ...
    <div class="row">
        <div class="col-12 col-xl-8">
            ...
            <div class="card card-body border-0 shadow mb-4">
                <h2 class="h5 mb-4">{{ __('ui.general_information') }}</h2>
                <form wire:submit.prevent="save" action="#" method="POST">
                        ...
                        <div class="col-md-6 mb-3">
                            <div>
                                ...
                                <input wire:model="user.first_name" class="form-control" id="first_name" type="text"
                                    placeholder="{{ __('ui.enter_first_name') }}" required>
                            </div>
                        </div>
                        <div class="col-md-6 mb-3">
                            <div>
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select wire:model="user.gender" class="form-select mb-0" id="gender"
                                ...
                                <option selected>{{ __('ui.choose') }}</option>
                    ...
                    <div class="mt-3">
                        <button type="submit" class="btn btn-gray-800 mt-2 animate-up-2">{{ __('ui.save_all') }}</button>
                    </div>
                </form>
                ...
                <div class="col-12 mb-4">
                    <div class="card shadow border-0 text-center p-0">
                        ...
                        <div class="card-body pb-5">
                            ...
                            <h5 class="fw-normal">{{ __('ui.job_title') }}</h5>
                            <p class="text-gray mb-4">{{ __('ui.location_value') }}</p>
                            ...
                            <a class="btn btn-sm btn-secondary" href="#">{{ __('ui.send_message') }}</a>
                        </div>
                    </div>
                </div>
            </div>
