<div class="theme-settings card bg-gray-800 pt-2 collapse" id="theme-settings">
    <div class="card-body bg-gray-800 text-white pt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            <p class="m-0 mb-1 me-4 fs-7">{{ __('ui.open_source') }} <span role="img" aria-label="gratitude">💛</span></p>
        ...
        <p class="fs-7 text-gray-300 text-center">{{ __('ui.available_in') }}</p>
        ...
        <div class="col-12 col-md-8 col-xl-6 text-center text-lg-start">
            ...
            <ul class="list-inline list-group-flush list-group-borderless text-md-end mb-0">
                <li class="list-inline-item px-0 px-sm-2">
                    <a href="https://themesberg.com/about">{{ __('ui.about') }}</a>
                </li>
                <li class="list-inline-item px-0 px-sm-2">
                    <a href="https://themesberg.com/themes">{{ __('ui.themes') }}</a>
                </li>
                <li class="list-inline-item px-0 px-sm-2">
                    <a href="https://themesberg.com/blog">{{ __('ui.blog') }}</a>
                </li>
                <li class="list-inline-item px-0 px-sm-2">
                    <a href="https://themesberg.com/contact">{{ __('ui.contact') }}</a>
                </li>
            </ul>
        </div>
    </div>
